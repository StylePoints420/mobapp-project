...
//     Map<int, TextEditingController> selectedControllers = {};
//     for (int i = 0; i < _checkboxStates.length; i++) {
//       if (_checkboxStates[i]) {
//         selectedControllers[i] = TextEditingController();
//       }
//     }
//     Navigator.of(context).push(
//       MaterialPageRoute(
//         builder: (context) => changeProductVal(selectedControllers: selectedControllers, selectedColumns: selectedColumns, controllers: controllers),
//       ),
//     );
//     for (int i = 0; i < _checkboxStates.length; i++) {
//       if (_checkboxStates[i]) {
